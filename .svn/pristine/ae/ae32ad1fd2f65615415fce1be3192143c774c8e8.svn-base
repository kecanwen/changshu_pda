	...
	export default {
		...
		methods: {
			...
			onSubmit() {
				...
				let _this = this;
				let inventoryStatuCode=this.$t('flatBatchReceipt').inventoryStatusCode[this.inventoryStatus.indexOf(this.inventoryStatu)];
			...
			onRefresh() {
				...
				setTimeout(() => {
					Toast(this.$t('flatBatchReceipt').RefreshSuccesMsg);
